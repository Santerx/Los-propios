...
public class boton7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boton7);
        ...
        botonvolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(boton7.this, MainActivity.class);
    ...
    public void mostrarAlertDialog() {
        ...
        dialogo.setTitle("SUPER CAMPEONES");
